 ...
 * ### 引用方法
 * ~~~js
 * import { Icon } from 'react-ui-components-pkg'
 * ~~~
 */
export var Icon = function (props) {
    var _a;
    var theme = props.theme, className = props.className, restProps = __rest(props, ["theme", "className"]); //className是FontAwesomeIconProps里定义的
    var classes = classNames("menu-icon", className, (_a = {},
        _a["icon-" + theme] = theme,
        _a));
